...
positionsFromNoTradeBuffer <- function(current_positions, current_prices, current_theo_weights, cap_equity, trade_buffer_low, trade_buffer_high) {
    .Call('_rsimsunsymm_positionsFromNoTradeBuffer', PACKAGE = 'rsimsunsymm', current_positions, current_prices, current_theo_weights, cap_equity, trade_buffer_low, trade_buffer_high)
}
